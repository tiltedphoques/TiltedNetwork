...
{
    template<>
    struct hash<TiltedPhoques::Endpoint>
    {
        typedef TiltedPhoques::Endpoint argument_type;
        typedef std::size_t result_type;

        result_type operator()(argument_type const& s) const noexcept
        {
            result_type result = 0;
            TiltedPhoques::hash_combine(result, (uint8_t)s.m_type);
            TiltedPhoques::hash_combine(result, s.m_port);
            ...
            TiltedPhoques::hash_combine(result, tmp);
